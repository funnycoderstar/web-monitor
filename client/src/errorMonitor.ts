...
// 收集静态资源异常
function getStaticResourcesError() {}
// promise异常
...
function getAjaxError() {
    function reportAjaxError(event: any) {
    ...
    function replaceAjax() {
        ...
        const _load = function (event: any) {
            console.log('执行ajax load 事件');
            _handleEvent(event);
        };
        const _error = function (event: any) {
            console.log('执行ajax error 事件');
            _handleEvent(event);
        };
        const _abort = function (event: any) {
            console.log('执行ajax abort 事件');
            _handleEvent(event);
        };
        const _close = function (event: any) {
...
function getFetchError() {
    function reportFetchError(event: any) {
...
export default function getErrorMonitor() {
    getJSError();
    getPromiseError();
    // getStaticResourcesError();
    getAjaxError();
    getFetchError();
}
